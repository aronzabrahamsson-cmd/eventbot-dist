...
(function () {
  ...
  const GUIDE_TAG_ROWS = [
    ...
    [null, 'tekniska museet, naturhistoriska museet, cosmonova', null, 'Science Museums in Stockholm', 'Museer för vetgiriga'],
    ...
    ['Music', 'nalen, debaser, kollektivet livet, cirkus, fållan', null, 'Upcoming concerts and music festivals', 'Kommande konserter & festivaler'],
  ...
  // Extra språkpar (2026-09-24, på begäran) för guider vars EN/SV-titlar
  // taggas av OLIKA GUIDE_TAG_ROWS-rader med olika nyckelord per språk
  // (höstlov/läslov → SV, halloween → EN) och därför inte redan täcks av
  // filtret ovan (som bara hittar par inom EN OCH SAMMA rad).
  const EXTRA_GUIDE_LANG_PAIRS = [
